...
def train_test_kink(cfg: dict, block_plot: bool, which_kernel: str, which_nonlin_sys = "true", Nobs = 20, random_pars=None, my_seed = None, plotting = True, savefig = False) -> None:
	...
	Nomegas_coarse = 31 # This is NOT Nomegas_per_div; we are trainig a tensor [Nomegas,dim_in_cntxt]
	...
	Dw_coarse = (2.*omega_lim_coarse)**dim_in_cntxt / Nomegas_coarse # We are trainig a tensor [Nomegas,dim_in_cntxt]
